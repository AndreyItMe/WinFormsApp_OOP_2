...
/*
        public void VisitCircle(Circle circle)
        {
            ...
            graphics.DrawEllipse(new Pen(circle.color), x, y, diameter, diameter);
...
/*
        public void VisitRectangle(WinFormsApp_OOP_1.GraphicsFigures.Figures.Rectangle rectangle)
        {
            ...
            //graphics.DrawRectangle(new Pen(Color.Black), _rectangle); //поменял цвет
            graphics.DrawRectangle(new Pen(rectangle.color), _rectangle);
        }
        ...
        public void VisitSquare(Square square)
        {
            ...
            graphics.DrawRectangle(new Pen(square.color), rectangle);
        }
        ...
        public void VisitEllipse(Ellipse ellipse)
        {
            ...
            graphics.DrawEllipse(new Pen(ellipse.color), rectangle);
        }

        public void VisitLine(Line line)
        {
            //graphics.DrawLine(new Pen(Color.Black), line.StartPoint, line.EndPoint);
            graphics.DrawLine(new Pen(line.color), line.StartPoint, line.EndPoint);
        }

        public void VisitPoint(Point point)
        {
            //graphics.DrawRectangle(new Pen(Color.Black), point.StartPoint.X, point.StartPoint.Y, 1, 1);
            graphics.DrawRectangle(new Pen(point.color), point.StartPoint.X, point.StartPoint.Y, 1, 1);
        }
*/
    }
}
