...
#pragma warning restore SYSLIB0011
        ...
        public void DeSerializeBIN()
        {
            ...
            using (FileStream fs = new FileStream("SerializeBIN.bin", FileMode.OpenOrCreate))
            {
                ...
                //Console.WriteLine("ќбъект десериализован");
            }
        ...
        {
            Assembly asm = Assembly.LoadFile("C:\\Users\\andrey\\Desktop\\4sem\\ќќ“ѕи—ѕ\\WinFormsApp_OOP_4\\WinFormsApp_OOP_4\\WinFormsApp1\\bin\\Debug\\net8.0-windows\\AssemblySandClock.dll");
            //C:\Users\andrey\Desktop\4sem\ќќ“ѕи—ѕ\WinFormsApp_OOP_4\WinFormsApp_OOP_4\WinFormsApp1\bin\Debug\net8.0-windows\AssemblySandClock.dll
            Type? factoryType = asm.GetType("WinFormsApp_OOP_2.Drawers.QuadrilateralFactory");
            Type? figureType = asm.GetType("WinFormsApp_OOP_1.GraphicsFigures.Figures.Quadrilateral");

            //var type = typeof(factoryType);
